...
phone = [(f'{V}/solar-m.png', 'ביום נטען. בלילה נדלק.', 'نفس نوع المكان نهاراً وليلاً: اللوح يشحن، وعند الغروب يضيء وحده. سطر واحد تحته، بلا زرّ ولا رابط. صورتان من صور منتجك «powerful solar garden light» (الثانية والثالثة في المعرض).'),
...
copy = [('איך עובדת תאורה סולארית?', 'عنوان القسم — سؤال؛ كلمة «شمسية» فيه تحصر الحقائق في المنتجات الشمسية (مصباح الجدار الكهربائي في البطاقات فوقه ليس شمسياً).'),
        ('ביום נטען. · בלילה נדלק.', 'العنوان مقسوماً على الإطارين: نهاراً يشحن، ليلاً يضيء.'),
        ('בלי חיבור לחשמל, בלי חשמלאי.', 'السطر الوحيد تحت الإطارين — عبارة قوائم منتجاتك نفسها. (كانت ثلاث خطوات مرقّمة؛ النقد وجد أن اثنتين منها تكرّران ما يقوله الإطاران والبطل، فبقي ما هو جديد فقط.)'),
        ...
        ('חושך הוא לא סוף הערב.', 'جملة واحدة على صورة السياج. ليست ادّعاءً. (عدسة «المالك» في النقد رأت أنها قريبة من جملة البطل «כשהשמש יורדת, הגינה נדלקת.»؛ أبقيتُها لأن البطل يتكلم عن المصابيح وهذه عن الناس — وهي حقل واحد في المحرّر إن أردت غيرها.)')]
