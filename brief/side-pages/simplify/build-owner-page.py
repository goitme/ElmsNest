...
drawer_html = f'<figure class="drawer"><img src="{drawer}" alt="" loading="lazy"><figcaption><b>الدرج بعد الإضافة</b>درج Kalles نفسه بالغلاف الليلي بعد جولة السلة: الاسم كاملاً، الخيار بالذهبي، سلّة حذف واحدة، سطر الشروط فوق المجموع، زر الدفع وحده كبير.</figcaption></figure>' if drawer else ''
...
<ul class="list admin">
<li><b>بريد info@elmsnest.com لا يستقبل.</b> النطاق بلا سجل MX (قِيس مرتين). وعد «ابعتلنا صورة للمكان» في كل صفحة يعتمد عليه — صندوق بريد للنطاق قبل النشر. الأول في الأهمية.</li>
...
<li><b>صور فيها علامة غريبة أو أرقام بلا سند</b> — صورة عمود LED الحديث تحمل شعار «LUMIÈRE»، وصورة مصابيح الممرّ المتأرجحة تحمل «50,000 שעות · +30%». الصور صورك ولا تُبدَّل من الشيفرة؛ في ورقة الصور علامة أولوية عليهما.</li>
<li><b>ترتيب «كل المنتجات»</b> — /collections/all عند Shopify تلقائية ومرتّبة أبجدياً؛ إن أردت ترتيبك أنت، أنشئ كولكشن باسم all بترتيب يدوي (Products ← Collections ← Create ← handle: all ← Sort: Manually).</li>
<li><b>عمود الممرّ من الستانلس</b> — له خيار واحد «צבע אור: צהוב חם» فتظهر له أزرار اختيار بلا اختيار؛ احذف الخيار من صفحة المنتج (Variants ← Options ← Remove) ويختفي المنتقي وحده.</li>
<li><b>أسماء طويلة</b> — العنوان صار يظهر كاملاً في ثلاثة أسطر؛ ومع ذلك، الأسماء الأقصر التي تبدأ بنوع المنتج تُقرأ أسرع على البطاقة (اقتراح، لا تغيير من عندي).</li>
<li><b>اسم المتجر في الرأس</b> — الشعار الحالي أيقونة بلا اسم؛ الزبون لا يقرأ «ElmsNest» قبل الفوتر. إن كان عندك نسخة من الشعار مع الاسم، ضعها في Theme settings ← Header ← Logo (عرض نحو 120 بكسل).</li>
</ul>
</div></section>
...
<li><b>النقد.</b> أربع عدسات، 34 ملاحظة، مشكّك على كل واحدة (30 أُكِّدت)، أحكامي مكتوبة قبل أن يعمل المصلح لا بعده؛ ثم نشر ثانٍ وقياس ثالث. أهم ما وجده النقد كان خطأً في شيفرتي أنا: نسخ الخيار إلى الشريط الملتصق لم يعمل يوماً.</li>
<li><b>جولة السلة.</b> خمسة مفاهيم وخمسة حكّام، ثم حكمك «جميل لكنه معقّد» — فلم يُبنَ أي مفهوم كما رُسم، بل ما أثبتته الخمسة معاً داخل درج Kalles الأصلي؛ مهندسان ومراجع عقد (بلا أخطاء حاجبة) ومصلح، والقياس قبل/بعد على أربعة أحجام شاشة.</li>
